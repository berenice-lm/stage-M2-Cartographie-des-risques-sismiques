...
var aggregation_essai = new ol.layer.Tile ({
    title: 'AE',
    visible: false,
    source: new ol.source.TileWMS({
        /* Chargement du lien WMS */
        url: 'https://lostinzoom.huma-num.fr/geoserver/geoserver_essai/wms',
        /* Chargement de l'espace de travail : couche */
        params: {'LAYERS': 'geoserver_essai:ensemble_essai', 'TILED': false},
...
var bddenjeux = new ol.layer.Group({
    title: 'Données à toutes les échelles',
    fold: true,
    layers: [aggregation_essai]
});
...
var blesses3 = new ol.layer.Tile ({
    ...
    source: new ol.source.TileWMS({
        ...
        url: 'https://lostinzoom.huma-num.fr/geoserver/wms',
        /* Chargement de l'espace de travail : couche */
        params: {'LAYERS': 'Nice_earthquake:cluster_com1', 'TILED': false},
        serverType: 'geoserver'
    })
});
